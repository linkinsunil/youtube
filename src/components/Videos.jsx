...
import { addToHistory } from '../utilities/history-utils';
import {
  addVideoToPlaylist,
  createPlaylist,
  deletePlaylist,
...
import { getFilteredVideos } from '../utilities/video-utils';
...
const Videos = () => {
  ...
  const {
    state: { likedVideos, watchLater, playlists, allVideos, category },
    dispatch,
  } = useVideo();

  console.log('allVideos', allVideos);

  const filteredVideos = getFilteredVideos(allVideos, category);
